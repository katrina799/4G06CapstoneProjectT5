...
\newcounter{srrnum} %Security Requirement number
...
\item \textbf{Data Encryption} [\label{Data_Encryption}]
  \begin{itemize}
  ...
  \end{itemize}
\item \textbf{Encrypted Data Storage} [\label{Encrypted_Data_Storage}]
  \begin{itemize}
  ...
  \end{itemize}
\item \textbf{Audit Log Maintenance} [\label{Audit_Log_Maintenance}]
  \begin{itemize}
  ...
  \end{itemize}
\item \textbf{Role-based Access Control} [\label{Role-based_Access_Control}]
  \begin{itemize}
  ...
  \end{itemize}
\item \textbf{Security Patches and Updates} [\label{Security_Patches_and_Updates}]
  \begin{itemize}
  ...
  \end{itemize}
\item \textbf{Attack Prevention} [\label{Attack_Prevention}]
  \begin{itemize}
  ...
  \end{itemize}
\item \textbf{Password Recovery} [\label{Password_Recovery}]
  \begin{itemize}
