...
Output/Result: Users report that all the texts are legible.
...
Output/Result: Users are comfortable with the color used.
...
Output/Result: Users are able to understand the meaning of each icon and graphic as designed.
...
Output/Result: Users are comfortable with the payout.
...
Output/Result: Users are able to locate menus and navigation tools without confusion.
...
Output/Result: No inconsistent UI elements are found.
...
Output/Result: The interactive UI element responses.
...
Output/Result: The font sized can be suitable for all the users.
...
Output/Result: Users could perform the task distracted.
