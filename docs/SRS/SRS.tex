...
\begin{itemize}[leftmargin=13.5mm,labelsep=4mm,label=\rthectreqnum]
    ...
    \textbf{Fit Criteria}:  User Interface (UI) elements, including icons and symbols, will undergo usability testing with a diverse group of at least 100 participants across different cultural backgrounds to ensure clarity and cultural appropriateness. The acceptable threshold for misunderstanding or offence will be less than 2\% of participants.\\
\end{itemize}
...
\begin{itemize}
  \item Integrate Google Calendar events into the website's task calendar
  ...
  \item Implement a feature where the users can integrate with other popular music apps like Spotify to play their favourite playlists while studying
  \item Implement a badge or achievements system such as points for completing tasks which can make the use of the website more engaging and rewarding 
