...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
addTask&  \textit{String} & \textit{Boolean} & internetError \\
...
getRemainingTime& - & \textit{Integer} & voidSession \\
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
getCGPA & \textit{File} & \textit{Float} & PDFParseException, CGPACalculationException \\
\hline
\end{tabular}
\end{center}
