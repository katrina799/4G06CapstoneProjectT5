...
\begin{itemize}[leftmargin=16.5mm,labelsep=4mm,label=\rthemreqnum]
    ...
    \textbf{Fit Criteria}: If a bug significantly impacts the regular user experience, the response time for resolution does not exceed 24 hours.
...
\begin{itemize}[leftmargin=16.5mm,labelsep=4mm,label=\rthesreqnum]
    ...
    \textbf{Fit Criteria}: Users are able to access the email contact, phone contact, and chatbot to address common user questions in 5 steps.\\
    \item The response time for offering support should be on time corresponding to the support type. \\
    \textbf{Fit Criteria}: For critical functionality disasters, the support should be delivered within 24 hours.\\
...
\begin{itemize}[leftmargin=16.5mm,labelsep=4mm,label=\rthecreqnum]
    ...
    \textbf{Fit Criteria}: The application can be translated into at least 5 languages(Spanish, French, Chinese, Italian and German).\\
